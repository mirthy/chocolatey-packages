...
Write-Host "Setting GOMAXPROCS to $env:NUMBER_OF_PROCESSORS"
Install-ChocolateyEnvironmentVariable "GOMAXPROCS" $env:NUMBER_OF_PROCESSORS Machine

Write-Host "Creating C:\consul\logs"
New-Item -ItemType directory -Path "C:\consul\logs" -ErrorAction SilentlyContinue | Out-Null
